...
export default function ConstructionPage() {
    return (
        <div className="flex justify-center">
            <div className="flex flex-col justify-center items-center gap-y-6 mt-4">
                <div className="text-8xl">🚨</div>
                <div className="text-4xl md:text-8xl font-bold text-center">This page is under construction.</div>

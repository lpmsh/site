            ...
            <div className="flex justify-center items-center ">
                <div className="  w-full lg:max-w-[66.6667%] flex flex-col  items-start gap-y-8 px-12">
                    ...
                    <div className="text-xl font-normal self-center justify-self-center">
                        Hey!
                        <span className="font-bold"> I&apos;m Liam.</span>{" "}
                        I&apos;m a Christian, student, developer,{" "}
                        <A href="/photos">photographer</A>, roboticist,
                        Pittsburgh and Ohio State sports fan, and an avid movie
                        and music consumer. You can usually find me coding, with
                        my{" "}
                        <A href="https://frc8592.org">awesome robotics team</A>,{" "}
                        <A href="/blog">writing about something</A>, or hanging
                        out with friends.
                    </div>
